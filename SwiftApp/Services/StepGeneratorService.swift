...
public final class StepGeneratorService {
    ...
    public func generateSteps(for taskTitle: String) async -> [Step] {
        if #available(iOS 26.0, *),
           let aiSteps = await generateWithAI(for: taskTitle) {
            return aiSteps
        }
    ...
    // MARK: - Communication
        ...
        private var emailSteps: [Step] { [
            ...
            Step(title: "Read it once, no pressure to reply yet"),
            Step(title: "Write one sentence with the main point"),
            Step(title: "Add the rest in short, clear lines"),
        ...
        private var messageSteps: [Step] { [
            ...
            Step(title: "Type one simple sentence"),
        ...
        private var phoneCallSteps: [Step] { [
            ...
            Step(title: "Write one line with what you need to say"),
        ...
        private var apologizeSteps: [Step] { [
            Step(title: "Write what you want to say first — just for you"),
            Step(title: "Keep it to two sentences: what happened and that you're sorry"),
            Step(title: "Choose how you'll reach out — text, call, in person"),
            Step(title: "Send it without endless editing"),
            Step(title: "Pause and remind yourself: you did your part")
        ]}
        
        private var difficultConversationSteps: [Step] { [
            Step(title: "Write down the one main thing you need to say"),
            Step(title: "Write what you're worried they might say"),
            Step(title: "Remind yourself you can handle this moment"),
        ...
        private var essaySteps: [Step] { [
            ...
            Step(title: "Write three points you want to make — just keywords"),
            ...
            Step(title: "Read it through once and fix the obvious things"),
        ...
        private var gymSteps: [Step] { [
            ...
            Step(title: "Leave the house and count that as a win"),
            Step(title: "Do your warmup"),
            Step(title: "Do your first exercise"),
            Step(title: "Finish your session"),
            Step(title: "Head home and acknowledge your effort")
        ]}
        ...
        private var sleepSteps: [Step] { [
            ...
            Step(title: "Close your eyes and let your body settle")
        ]}
        ...
        private var mealSteps: [Step] { [
            ...
            Step(title: "Sit down and eat, with as few distractions as possible"),
        ...
        private var billSteps: [Step] { [
            ...
            Step(title: "Save confirmation or note that it's done")
        ]}
        ...
        private var scheduleSteps: [Step] { [
            ...
            Step(title: "Pick one time that feels workable"),
            Step(title: "Book it"),
            Step(title: "Add it to your calendar")
        ]}
        ...
        private var cancelSteps: [Step] { [
            ...
            Step(title: "Write your reason in one sentence"),
            Step(title: "Call, email, or cancel online"),
            Step(title: "Confirm the cancellation"),
            Step(title: "Note that it's done")
        ]}
        ...
        private var cleanSteps: [Step] { [
            ...
            Step(title: "Take one look and call it done")
        ]}
        ...
        private var presentationSteps: [Step] { [
            ...
            Step(title: "Practice saying it out loud one time"),
            Step(title: "Present")
        ]}
        ...
        private var deadlineSteps: [Step] { [
            ...
            Step(title: "Mark it done and take one breath")
        ]}
        ...
        private var socialSteps: [Step] { [
            ...
            Step(title: "Acknowledge that showing up is progress")
        ]}
        ...
        private var genericSteps: [Step] { [
            ...
            Step(title: "Mark it done and pause for a breath")
        ]}
    }
